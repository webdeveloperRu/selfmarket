<template>
  <div style="height: 92vh;" class="flex">
    ...
    <div class="q-pa-md q-gutter-y-sm container">
      ...
      <div>
        ...
        <p style="font-size: 15px; font-weight: 300" class="text-grey-6">
          ...
          create your work on other platforms, and come back and sell your work
          on Selfmarket.
        </p>
      </div>
      <div class="row">
        <div class=" col-md-3 col-sm-6 col-xs-12 q-pa-sm ">
          <q-card class="cursor-pointer" style="height: 200px">
            <q-card-section class="q-py-md">
              <div class="text-h5 text-center q-my-md" style="font-weight: 600">
                <q-img
        ...
        <div class=" col-md-3 col-sm-6 col-xs-12 q-pa-sm ">
          <q-card class="cursor-pointer" style="height: 200px">
            <q-card-section class="q-py-md">
              ...
              <div class="text-center text-grey-6 q-my-sm">
                Mintbase is a refined platform for creating digital assets, with
                support for batch minting ERC721s.
              </div>
            </q-card-section>
          </q-card>
        </div>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      publicCollections: "manage/publicCollections",
  ...
  methods: {
    ...
    createCollection() {
      ...
      this.$store.dispatch("manage/addCollection", collection).then(() => {
        ...
        if (this.requestSuccess) this.createCollectionModal = false;
      });
    }
  }
};
