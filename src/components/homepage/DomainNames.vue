  ...
  <div class="row ">
    ...
    <div class="col-3 q-pa-sm">
      <q-avatar size="70px" font-size="52px" text-color="white" class="q-mb-md">
        <q-img src="../../assets/images/categories/domain.png"></q-img>
      </q-avatar>
      ...
      <div class="text-subtitle2 text-grey-9" style="font-weight: 400">
        Turning hexadecimal wallet addresses into human-readable names is big
        business in crypto. Browse thousands of censorship-resistant domain
        names right here on OpenSea.
      </div>
