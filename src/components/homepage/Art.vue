  ...
  <div class="row">
    ...
    <div class="col-4 q-pa-sm">
      <q-avatar size="70px" font-size="52px" text-color="white" class="q-mb-md">
        <q-img src="../../assets/images/categories/art.png"></q-img>
      </q-avatar>
      ...
      <div class="text-subtitle2 text-grey-9" style="font-weight: 400">
        Blockchain technology changes the way we make, trade, and enjoy art.
        With provenance recorded and stored on a distributed ledger, market
        power is shifting back to the creators.
      </div>
