    ...
    <div class="row q-mx-sm q-mt-xl">
      <div class="col-12 col-md-6">
        ...
        <div class="text-white text-subtitle1 q-py-lg q-px-sm text-center">
          ...
          non-fungible tokens (NFTs), including ERC721 and ERC1155 assets. Buy,
          sell, and discover exclusive digital assets like Axies, ENS names,
          CryptoKitties, Decentraland, and more.
        </div>
      </div>
